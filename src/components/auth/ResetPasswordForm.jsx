        ...
        <div className="p-14 rounded-2xl w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full px-3 py-2 border text-[#5C5C5C] text-xs rounded-sm ${errors.password ? "border-red-500" : "border-[#1F3D2C]"
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full px-3 py-2 border  text-[#5C5C5C] text-xs rounded-sm ${errors.confirmPassword ? "border-red-500" : "border-[#1F3D2C]"
                    } focus:outline-none cursor-pointer`}
            ...
            <button
              ...
              className="w-full bg-[#1F3D2C] border disabled:cursor-not-allowed border-gray-400 text-white py-2 text-xs px-4 hover:bg-[#1f3d2cdc] transition duration-200 cursor-pointer disabled:opacity-70 rounded-sm"
            >
